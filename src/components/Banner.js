                ...
                <div className="max-w-7xl mx-auto py-2 px-2 sm:px-6 lg:px-8">
                    ...
                    <div className="w-0 flex-1 flex items-center">
                        ...
                        <span className="md:hidden">
                            Yeni bir ürün duyurduk!
                        </span>
                        <span className="hidden md:inline">
                            Yeni ürünlerde kaçınılmaz fırsatlar. Fırsatlardan yararlanmak için son 2 gün kaldı!
                        </span>
                        </p>
                    </div>
                    ...
                    <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                        <button type="button" className="-mr-1 flex p-2 rounded-full hover:bg-indigo-400 focus:outline-none sm:-mr-2">
